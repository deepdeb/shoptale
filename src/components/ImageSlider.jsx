        ...
        {slides.map((slide, index) => (
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
              ...
              <button className="bg-white text-gray-900 px-6 md:px-8 py-2 md:py-3 rounded-full font-semibold text-sm md:text-base hover:bg-gray-100 transition-all transform hover:scale-105 shadow-lg">
                {slide.button}
              </button>
            </div>
          </div>
